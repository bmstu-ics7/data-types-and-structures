...
различной его реализации?**<br>В случае реализиции массивом память выделяется сразу на максимальный размер стека. При реализации списком память выделяется отдельно для каждого элемента при добавлении его с стек.<br><br>
